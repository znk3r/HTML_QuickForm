...
class HTML_QuickForm_Renderer_ArraySmarty extends HTML_QuickForm_Renderer_Array
{
     ...
     * @param bool $required The element required
    ...
    public function _renderRequired(&$label, &$html, &$required, &$error)
    {
        ...
        if (!empty($label) && false !== strpos($this->_required, $this->_tpl->left_delimiter.'$label')) {
            $label = $this->_tplFetch($this->_required);
        }
        if (!empty($html) && false !== strpos($this->_required, $this->_tpl->left_delimiter.'$html')) {
    ...
    public function _renderError(&$label, &$html, &$error)
    {
        ...
        if (!empty($label) && false !== strpos($this->_error, $this->_tpl->left_delimiter.'$label')) {
            $label = $this->_tplFetch($this->_error);
        } elseif (!empty($html) && false !== strpos($this->_error, $this->_tpl->left_delimiter.'$html')) {

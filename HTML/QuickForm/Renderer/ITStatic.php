...
class HTML_QuickForm_Renderer_ITStatic extends HTML_QuickForm_Renderer
{
     ...
     * Constructor.
     *
     * @param HTML_Template_IT|HTML_Template_Sigma $tpl Template object to use
     */
     ...
     *
     * @param HTML_QuickForm $form form object being visited
     */
     ...
     *
     * @param HTML_QuickForm_element $element hidden element being visited
     */
        ...
        if (!empty($html)) {
            ...
            if (!empty($error)) {
                if ($this->_tpl->placeholderExists($varName.'_error')) {
                    ...
                    } elseif (false !== strpos($this->_error, '{html}') || false !== strpos($this->_error, '{label}')) {
    ...
    public function _renderRequired(&$label, &$html)
    {
        if ($this->_tpl->blockExists($tplBlock = $this->_formName.'_required_block')) {
            ...
            if (!empty($label) && false !== strpos($this->_required, '{label}')) {
                if (is_array($label)) {
            ...
            if (!empty($html) && false !== strpos($this->_required, '{html}')) {
    ...
    public function _renderError(&$label, &$html, $error)
    {
        ...
        } elseif (!empty($label) && false !== strpos($this->_error, '{label}')) {
            if (is_array($label)) {
        ...
        } elseif (!empty($html) && false !== strpos($this->_error, '{html}')) {
